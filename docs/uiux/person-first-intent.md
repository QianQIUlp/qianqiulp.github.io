...
视觉方案会继续变化。房间、宣纸、界画、卷轴和朱砂只是现阶段的表达工具，
不是千秋这个人的定义，也不是未来改版必须保存的教条。应长期保存的是下面的阅读关系：
...
恰恰相反：第一层认识应由光、阴影、墨、吉他与空间远近来代言；真实内容在读者靠近后出现，
...
“同一世界”不是把首页截图搬到每一页，而是让空间与阅读遵循同一组物理规则：

- 同一纸底：页面本身就是纸，不再在页面上堆第二层卡片底板；
- 同一墨阶：重要性由焦、浓、重、淡、清和留白表达；
- 同一光源：需要投影时只接受左上来光、右下落影；
- 同一边界：图像以渐隐或墨化边缘进入纸面，内容用栏线和缩进组织；
- 同一克制：朱砂只作落款与批注，书体只作签名，界面不显示印章；
- 同一动作：显影是唯一入场动作，主题切换只改变明暗浓淡，不改变构图和信息。
...
7. 若下一版完全放弃“墨光书房”，仍能说明它如何保留了这里的人本意图吗？
