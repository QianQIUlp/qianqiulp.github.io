...
PubkeyAuthentication yes</code></pre>
    ...
    <h3>P1.4 处理 Ubuntu socket activation 坑（24.04+ 必看）</h3>
    <aside>
...
sudo systemctl enable --now ssh.service</code></pre>
    ...
    <h3>P2.1 自动安全更新（unattended-upgrades）</h3>
